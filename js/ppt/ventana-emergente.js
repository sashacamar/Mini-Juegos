...
$("#boton-piedra").on("mouseenter", () => {$("#boton-piedra").attr("src", "../assets/ppt/ventana-emergente/piedra-hover.png");});
$("#boton-piedra").on("mouseleave", () => {$("#boton-piedra").attr("src", "../assets/ppt/ventana-emergente/piedra.png");});
...
$("#boton-papel").on("mouseenter", () => {$("#boton-papel").attr("src", "../assets/ppt/ventana-emergente/papel-hover.png");});
$("#boton-papel").on("mouseleave", () => {$("#boton-papel").attr("src", "../assets/ppt/ventana-emergente/papel.png");});
...
$("#boton-tijera").on("mouseenter", () => {$("#boton-tijera").attr("src", "../assets/ppt/ventana-emergente/tijera-hover.png");});
$("#boton-tijera").on("mouseleave", () => {$("#boton-tijera").attr("src", "../assets/ppt/ventana-emergente/tijera.png");});
