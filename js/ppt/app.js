...
class Partida {
    ...
    imprimirPartida() {
        ...
        $("#vos").attr("src", `../assets/ppt/img/${this.eligio}_vos.png`);
        $("#pc").attr("src", `../assets/ppt/img/${this.pcAtaca}_pc.png`);
        $("#resultadoPartida").attr("src", `../assets/ppt/img/${this.resultado}.png`);
