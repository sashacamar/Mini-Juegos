...
salir.addEventListener("click", () => {if(ventanaEmergente == 1){ventanaEmergente=0; localStorage.setItem("Estado_Ventana", ventanaEmergente); localStorage.setItem("Estado_Ventana", ventanaEmergente); ventana.classList.add("cierre-ventana")}});
...
boton_piedra.addEventListener("click", () => {if(ventanaEmergente == 1){ventanaEmergente=0; localStorage.setItem("Estado_Ventana", ventanaEmergente); ventana.classList.add("cierre-ventana")}; opcion_jugador = "Piedra"; click=1; juego();});
...
boton_papel.addEventListener("click", () => {if(ventanaEmergente == 1){ventanaEmergente=0; localStorage.setItem("Estado_Ventana", ventanaEmergente); ventana.classList.add("cierre-ventana")}; opcion_jugador = "Papel"; click=1; juego();});
...
boton_tijera.addEventListener("click", () => {if(ventanaEmergente == 1){ventanaEmergente=0; localStorage.setItem("Estado_Ventana", ventanaEmergente); ventana.classList.add("cierre-ventana")}; opcion_jugador = "Tijera"; click=1; juego();});
